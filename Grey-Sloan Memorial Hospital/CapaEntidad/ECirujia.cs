...
namespace CapaEntidad
{
    public class ECirujia
    {
        ...
        public ECirujia(int id, int id_quirofano, int id_cirujano_principal, int id_cirujano2, int id_enfermero1, int id_enfermero2, int id_paciente, DateTime fecha, DateTime horaInicio, DateTime horaFinal)
        {
            this.id = id;
